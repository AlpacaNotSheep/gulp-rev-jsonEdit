...
var serverPath = '../Publish/content/hybrid/',
    ...
    // 资源文件cdn前缀
    //http://r03.uzaicdn.com/content/hybrid/
    uzaicdn = '//r03.uzaicdn.com/content/hybrid/',
    ...
    jsonFormat = {
        ...
        'update': {
            ...
            'font': [],
            'libs': [{
                'file': '//r03.uzaicdn.com/content/libs/jquery-2.1.1.min.js',
                'ver': '3605660716'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/frame/angular/angular.min.js',
                'ver': '1723460373'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/frame/angular/angular-lazyload.js',
                'ver': '2570371747'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/plugin/swiper/swiper-3.3.1.min.js',
                'ver': '1466904961'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/plugin/swiper/swiper.min.css',
                'ver': '2951268204'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/plugin/iscroll/iscroll.js',
                'ver': '108983682'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/plugin/swiper/swiper.animate.min.js',
                'ver': '4251710681'
            }, {
                'file': '//r03.uzaicdn.com/content/libs/frame/vue/vue.js',
                'ver': '3544575529'
            }]
        },
        'replace': {
            '.html': [{
                'old': 'https://r03.uzaicdn.com',
                'new': '../../../r03.uzaicdn.com'
            }, {
                'old': 'https://r03.uzaicdn.com',
                'new': '../../../r03.uzaicdn.com'
